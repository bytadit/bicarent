...
export class Model {
    ...
    public static async insert<Payload, Result>(data: Payload): Promise<Result & DateType> {
        const [result] = await this.table.insert(data).returning('*');
        return result;
    }

    public static async update<Payload, Result>(id: string, data: Payload): Promise<Result & DateType> {
    ...
    public static async findById<Result>(id: string): Promise<Result & DateType> {
